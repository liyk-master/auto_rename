...
class TestTMBDClient(unittest.TestCase):
    ...
    def test_request_with_retry_success(self, mock_session_class):
        ...
        mock_response.json.return_value = {"status_code": 200, "status_message": "Success"}
    ...
    def test_request_with_retry_failure_then_success(self, mock_sleep, mock_session_class):
        """
        测试请求重试机制 - 失败后成功
        """
        # 设置模拟会话
        ...
        mock_response_success.json.return_value = {"status_code": 200, "status_message": "Success"}
